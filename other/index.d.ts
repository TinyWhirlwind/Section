import { BufferGeometry, Group, InstancedMesh, Line3, LineSegments, Mesh, MeshPhongMaterial, Plane, Triangle, Vector3, Matrix4} from 'three';
...
export const SECTION: CSGOperation;

export class ExtendEvaluator {
  ...
  getBorderList();
  setPlane(planeCenter: Vector3, planeNormal: Vector3);
  evaluateHierarchy( root: Operation, target?: Brush ): Brush;
  sectionGeneration(sectionResult: Mesh, matrixWorld: Matrix4);
}
...
export class ExtendTriangleSplitter {
